...
const steps = [
  {
    ...
    description:
      'Clarify goals, target audiences, and offers to make sure each content test is anchored to business outcomes.',
    items: [
  ...
  },
  {
    ...
    description:
      'Audit competitor hooks, trend reports, and creator content to build a vetted list of angle ideas.',
    items: [
  ...
  },
  {
    ...
    description:
      'Translate shortlisted hooks into ready-to-record scripts with supporting visuals or references.',
    items: [
  ...
  },
  {
    ...
    description:
      'Plan the rollout cadence and ensure every post is tracked against the agreed metrics.',
    items: [
  ...
  },
  {
    ...
    description:
      'Synthesize results, double down on winning hooks, and queue the next batch of tests.',
    items: [
  ...
  return (
    <div className="container section stack-lg">
      <div className="stack-md">
        ...
        <p className="lead">
          A structured, four-week workflow for researching hooks, scripting content, and tracking the results that move
          inquiries.
        </p>
      </div>
