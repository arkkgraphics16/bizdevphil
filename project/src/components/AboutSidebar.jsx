...
const contactIcons = {
  phone: (
    <svg viewBox="0 0 24 24" aria-hidden="true" focusable="false">
      <path
        fill="currentColor"
        d="M20.85 15.54 18 14.9a1.7 1.7 0 0 0-1.61.49l-1.76 1.81a13.3 13.3 0 0 1-5.83-5.83l1.8-1.77a1.7 1.7 0 0 0 .49-1.61L10.45 5.2a1.7 1.7 0 0 0-1.92-1.31l-2.9.58a1.7 1.7 0 0 0-1.35 1.66A15.95 15.95 0 0 0 20.23 22a1.7 1.7 0 0 0 1.66-1.35l.58-2.9a1.7 1.7 0 0 0-1.32-1.9Z"
      />
    </svg>
  ),
  email: (
    <svg viewBox="0 0 24 24" aria-hidden="true" focusable="false">
      <path
        fill="currentColor"
        d="M20.5 4h-17A1.5 1.5 0 0 0 2 5.5v13A1.5 1.5 0 0 0 3.5 20h17a1.5 1.5 0 0 0 1.5-1.5v-13A1.5 1.5 0 0 0 20.5 4Zm-.32 2-7.68 6.08L5.45 6ZM4 18v-8.35l8 6.34 8-6.34V18Z"
      />
    </svg>
  ),
  location: (
  ...
  [
    ...
    contact?.address
      ? {
          ...
          external: Boolean(contact.mapLink),
        }
      : null,
  ].filter(Boolean);

export default function AboutSidebar({ identity, contact }) {
  const portraitSrc = identity?.portrait?.src
    ? resolveAssetPath(identity.portrait.src)
    : '';
